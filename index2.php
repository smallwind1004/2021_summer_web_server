    ...
    <footer class="text-center text-white fixed-bottom" style="background-color: rgb(127, 127, 127);">
        <div class="container p-4 pb-0">
            ...
            <section class="mb-4">
                ...
                <!-- Instagram -->
                <a class="btn btn-primary btn-floating m-1" role="button" style="background-color: rgb(172, 43, 172);" href="https://www.instagram.com/smallwind_09_25/">
        ...
        <div class="text-center p-2" style="background-color: rgba(0, 0, 0, 0.2);">
            ...
            <b>Powered by 曉風</b> @ 2021 Copyright
            <a class="text-white" href="mailto: o20392o@gmail.com"> o20392o@gmail.com</a>
        </div>
